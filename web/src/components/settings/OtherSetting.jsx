...
const OtherSetting = () => {
  ...
  const checkUpdate = async () => {
    try {
      ...
      //   `${proxyUrl}https://api.github.com/repos/Calcium-Ion/buzz/releases/latest`,
      // );

      // Option 2: Use the JSON proxy approach which often works better with GitHub API
      const res = await fetch(
        'https://api.github.com/repos/Calcium-Ion/buzz/releases/latest',
        {
          headers: {
  ...
  const openGitHubRelease = () => {
    window.open(
      `https://github.com/Calcium-Ion/buzz/releases/tag/${updateData.tag_name}`,
      '_blank',
    );
  };
